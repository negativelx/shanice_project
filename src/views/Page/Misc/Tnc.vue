<template>
    <div class="flex flex-wrap w-full">
        ...
        <div ref="pdfWrapper" :class="pdfWrapperClass"
             class="post-content-wrapper w-full md:w-8 mb-0 bg-white border-round-3xl">
            <ProgressSpinner class="flex align-self-center p-5 h-full" v-if="pdfLoading"/>
...
import tncMember from "@/assets/pdf/tnc-member.pdf";
